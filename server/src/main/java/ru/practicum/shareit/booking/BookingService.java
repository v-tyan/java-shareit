...
public interface BookingService {
    ...
    List<BookingDtoResponse> getBookings(long ownerId, String state, int from, int size);

    List<BookingDtoResponse> getBookingFromOwner(long ownerId, String state, int from, int size);
}
